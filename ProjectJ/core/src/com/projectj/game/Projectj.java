...
import com.projectj.game.personnage.*;
import com.projectj.game.ReadFile;
import com.badlogic.gdx.math.Rectangle;
import com.projectj.game.Obstacle.*;
...
public class Projectj extends ApplicationAdapter {
	...
	public void create () {
		...
		backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("MM2_theme.mp3"));
		...
		balleBoss = new Bullets(10, 16, 16, 10, 30, 20);
		...
		//LE BOSS
		boss = new Boss("Splinter", 4, 130, 75, Gdx.graphics.getWidth() - 130, 75, balleBoss, 10);
	...
	public void render () {
		...
		if(backgroundMenu.is_finish()){
			...
			if(!character.isDead()){//Tant qu'on est en vie
				...
				System.out.println("RIP Bozo HAHAHA !!!");
				//GAME OVER
				return;
			}
		}
