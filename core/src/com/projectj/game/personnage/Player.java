...
public class Player extends Personnage{
    ...
    public Sound jetpackSound = Gdx.audio.newSound(Gdx.files.internal("Sounds/JetpackSound.mp3"));
    public long id = jetpackSound.play(0.0f);
    ...
    private boolean collidesWithRocket(Rocket rocket){
        int collisionX = rocket.getX() - this.x;
    ...
    public boolean collidesWithObstacle(ReadFile readFile){
        float x_perso_droit=this.x+this.width-10;
        float x_perso_gauche=this.x;
        float y_perso_bas=this.y;
