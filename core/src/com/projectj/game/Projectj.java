...
import com.projectj.game.background.*;
import com.projectj.game.personnage.*;
import com.projectj.game.utility.*;
...
public class Projectj extends ApplicationAdapter {
	...
	@Override
	public void create () {
		boss = new Boss("Splinter", 50, 130, 75, Gdx.graphics.getWidth() - 130, 75, balleBoss1, 10);
	...
	public void render () {
		...
		*/
		...
		if(backgroundMenu.is_finish()){
			...
			for(Rectangle b : readFile.getBlocks()){
